...
For most purposes the fourth-root condition doesn't really matter: if you have a fixed finite-dimensional parameter that you can estimate at all, you can probably estimate it at root-$n$ rate, and if your parameters are infinite-dimensional or growing in size with $n$ you need to worry about more than just powers of $n$ in remainders.  However, if you *needed* root-$n$ convergence you'd worry that low efficiency would be a problem in sub-asymptotic settings, which is less of a worry now. 
