...
Last year, Rob Speer wrote a really great post [http://blog.conceptnet.io/posts/2017/how-to-make-a-racist-ai-without-really-trying/](How to make a racist AI without really trying). Go read it.
...
As a check on accuracy, I'll set aside 20% of the training set for testing. We shouldn't really need to do that, because we trust `glmnet` and its cross-validation, but it matches the original post.
