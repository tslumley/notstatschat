...
Interaction or effect modification is scale-dependent: you ask _"is the effect of A on X in the presence of B the same as the effect of A on X in the absence of B."_ This requires reducing "the effect" to a single number or other low-dimensional summary.  If A and B both have an effect on X there must be summaries that show an interaction -- the effect can't be both exactly additive and exactly multiplicative, for example -- so interaction is intrinsically more statistical and model-based than confounding.
...
In Australia before the _Haemophilus influenzae_ type B (Hib) vaccine, the Hib meningitis rate was 4.5/100000/year in indigenous communities and 1.7/100000/year in the rest of the population.
