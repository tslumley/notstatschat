...
When talking about trust important caveat is whether the package (or the method) has been used in situations **similar to the one you want to use it in**.  I'll give two historical examples.
