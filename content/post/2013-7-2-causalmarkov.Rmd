---
title: "Problems with faithfulness and the causal Markov property (I)"
...
Note that 'measurement error' here is used in the statistician's sense, meaning any difference between A and A*. It includes measurement error _sensu stricto_, but also the error in representing a long-term average by a single measurement (eg, blood pressure measurement), and the error due to A* not being quite the right variable (eg, C-reactive protein as a marker for inflammation)