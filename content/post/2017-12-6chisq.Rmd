...
**Update**: If you need something to cite, the [paper is now online](https://www-sciencedirect-com.ezproxy.auckland.ac.nz/science/article/pii/S0167947319301136) in *Computational Statistics and Data Analysis*.  Yes, sorry, it's an Evil Elsevier journal, but it's also where previous papers on the subject have appeared.