...
We have [a paper](https://pubmed.ncbi.nlm.nih.gov/35775996/) coming out in *Biometrics* describing a reasonably complicated example of validation sampling from electronic health records.  "We" here is a lot of people: Bryan E Shepherd, Kyunghee Han, Tong Chen, Aihua Bian, Shannon Pugh, Stephany N Duda, Thomas Lumley, William J Heerman, Pamela A Shaw.  Pam and Bryan led the project from the statistical side, William Heerman was the clinical lead. 
